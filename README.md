...
**A note on authorship.** I've tried to reach the original Kaleidoscope authors (Greg Landweber, Arlo Rose, and a handful of scheme authors I could find addresses for) to ask their blessing on this project. I haven't gotten replies, and most of the addresses I could find are decades old. If you know how to reach them, or if you ARE one of them reading this, please get in touch: <khawkins98@gmail.com>.

My read of Scriptoscope's relationship to Kaleidoscope: it's an **API-compatible re-implementation** of the scheme format, written clean-room from the decompiled 2.3.1 kDEF. No original Kaleidoscope code ships or executes; the compositor is independent code that reads the same resource files the 1998 control panel did. The closest legal precedent I'm aware of is [*Google v. Oracle* (2021)](https://en.wikipedia.org/wiki/Google_LLC_v._Oracle_America,_Inc.), where the Supreme Court held Google's reimplementation of Java APIs in Android was fair use. This project is a hobby, MIT-licensed, no profit motive, no advertising. If any of the original authors object, I'll take it down.

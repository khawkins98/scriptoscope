...
|---|---|---|---|---|---|
| platinum-8 | document | title-bar pinstripe washed out / low-contrast vs aplat2+system7 | pinstripe sprite vs `isHorizontalLineStripe` tile/stretch + inset | shipped `cicn` + WDEF pinstripe (AA00, 2-row) | open |

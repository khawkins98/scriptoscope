...
| apple-platinum-2, platinum-8, system7 | document | widgets flat / poor color (tan tint on aplat2) | `extract-icons.mjs` preferred **ics4 (4-bit/16-col) over ics8 (8-bit/256-col)** at the same id — discarded the richer shipped ics8; the tan was a 4-bit palette artifact | the scheme's own shipped ics8 (8-bit) | **CLOSED** — extractor now prefers 8-bit; re-extracted the 3 schemes → widgets gain depth/sheen + correct gray (no tan). ics4-n14336=4 colors → ics8=9. (black-platinum already ics8.) |

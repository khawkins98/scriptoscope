...
- Validation demos: `demo/index.html` (the 2026-05-30 landing — four named-technology cards as floating Mac windows + a hero control strip exercising button / checkbox / radio / slider over native form widgets) and `demo/declarative-hostile-css.html` (the Decision 2 litmus test under hostile host CSS). Both exercise the data-attribute scanner, themed controls, runtime theme switch, scroll/shade/zoom. (Earlier demos retired: `demo/declarative.html` 2026-05-28; `demo/declarative-site.html` 2026-05-30 when its skin-an-existing-site coverage was absorbed by the new landing + the now-renamed `demo/diagnostic.html` showcase.)

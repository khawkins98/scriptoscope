...
Risk/dependency: if neither in-repo source yields a clean ramp, a trustworthy Platinum reference image is needed (ties into `docs/spec/golden-reference-todo.md`).
